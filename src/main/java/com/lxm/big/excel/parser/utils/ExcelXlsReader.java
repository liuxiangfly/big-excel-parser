...
/**
 * 
 * ClassName: com.lxm.big.excel.parser.utils.ExcelXlsReader <br/>
 * Function: 用于解决.xls2003版本大数据量问题<br/>
 * Date: 2020年7月26日 下午3:11:59 <br/>
...
public class ExcelXlsReader implements HSSFListener {
	...
	public void processRecord(Record record) {
		...
		case NumberRecord.sid: // 单元格为数字类型
			...
			value = formatter.formatRawCellContents(valueDouble, formatIndex,
					formatString).trim();
